import {convertToCoffeeObject, CoffeeDTO} from "./../../dto/CoffeeDTO";
...
describe( 'Testing Coffee Object Conversion', ()=>{
    it('converts dictionary to coffee object', ()=>{
        ...
        const output = convertToCoffeeObject(input);
    ...
    it('creates new Coffee DTO object', ()=>{
        const coffeeDTO = new CoffeeDTO(0, "Coffee", 1, "Cup", 300, true, 5.00);
